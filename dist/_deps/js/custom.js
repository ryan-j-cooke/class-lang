...
function showAndHideDialog (callId) {
  $('.tech-info').hide()
  var newId = $('#' + callId)
  newId.show()
  // console.log(newId);
...
/* -- check id tech info -- */
$('#tech-logo-1').hover(function () {
  var logo_id = ($('#tech-logo-1').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-2').hover(function () {
  var logo_id = ($('#tech-logo-2').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-3').hover(function () {
  var logo_id = ($('#tech-logo-3').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-4').hover(function () {
  var logo_id = ($('#tech-logo-4').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-5').hover(function () {
  var logo_id = ($('#tech-logo-5').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-6').hover(function () {
  var logo_id = ($('#tech-logo-6').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-7').hover(function () {
  var logo_id = ($('#tech-logo-7').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})

$('#tech-logo-8').hover(function () {
  var logo_id = ($('#tech-logo-8').attr('id'))
  var lastCharId = logo_id.substr(logo_id.length - 1)
  var callId = 'tech-info-' + lastCharId
  showAndHideDialog(callId)
})
